    ...
    public void update(float deltaTime){
        ...
        for(int i = 0; i < len; i++) {
            ...
            if(event.type == TouchEvent.TOUCH_UP){
                ...
                else if(inBounds(event, gameGridXPos, gameGridYPos, gameGrid.getWidth(), gameGrid.getHeight()) && touchTimes == 1)//second TouchEvent.TOUCH_UP
                {
